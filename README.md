...
The [4B curriculum candidate](research/CURRICULUM_300_FAMILY_MILESTONE.md) has now reached its planned scale: 300 independent balanced families produce 900 linked atomic-check, method-composition and solve/commit views. All 20 expansion batches were closed separately and the aggregate image/hash/split/target/processor audit passed twice identically. Seven unusable or non-unique source records were rejected and replaced in the same exam cell. No 4B optimizer update has run; private questions and answers are excluded. Independent subject-expert review and a separately frozen release remain required before training. The earlier [60-family tranche](research/FIRST_4B_CURRICULUM_TRANCHE.md) remains as the first auditable milestone.
